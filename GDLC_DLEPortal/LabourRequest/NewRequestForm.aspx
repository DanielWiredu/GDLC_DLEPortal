<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewRequestForm.aspx.cs" Inherits="GDLC_DLEPortal.LabourRequest.NewRequestForm" %>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <asp:Button runat="server" ID="btnSaveRequest" CssClass="btn btn-success" Text="Save Request" OnClick="btnSaveRequest_Click" />  
                                                <asp:Button runat="server" ID="btnAddNew" CssClass="btn btn-danger" Text="Create New" CausesValidation="false" OnClick="btnAddNew_Click" /> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                       ...
                                       <telerik:RadComboBox ID="dlLabourCategory" runat="server" Width="100%" DataSourceID="categorySource" MaxHeight="200" EmptyMessage="Select Category" DataValueField="Id" DataTextField="LabourCategory" Filter="Contains" HighlightTemplatedItems="true" MarkFirstMatch="true" AllowCustomText="false">
                                        </telerik:RadComboBox>
