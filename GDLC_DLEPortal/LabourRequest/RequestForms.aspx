<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="RequestForms.aspx.cs" Inherits="GDLC_DLEPortal.LabourRequest.RequestForms" %>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <asp:Button runat="server" ID="btnAddNew" CssClass="btn btn-success" Text="Add New" CausesValidation="false" PostBackUrl="~/LabourRequest/NewRequestForm.aspx"/>
                                            </div>
                                        </div>
                                    </div>
