<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewUser.aspx.cs" Inherits="GDLC_DLEPortal.Security.NewUser" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <FooterTemplate>
                ...
                items
                     ...
                     <div class="form-group">
                         ...
                         <label>Account Type</label>
                           <telerik:RadDropDownList ID="dlAccoutType" runat="server" Width="100%" >
                             <Items>
                                 <telerik:DropDownListItem Text="Employer" Selected="true" />
                             </Items>
                         </telerik:RadDropDownList>
                            </div>
                         <div class="col-md-6">
                    ...
                    <asp:Button ID="btnAddNew" runat="server" CssClass="btn btn-danger" Text="Add New" CausesValidation="false" OnClick="btnAddNew_Click"/>              
