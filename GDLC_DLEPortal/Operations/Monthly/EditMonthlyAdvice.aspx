<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditMonthlyAdvice.aspx.cs" Inherits="GDLC_DLEPortal.Operations.Monthly.EditMonthlyAdvice" %>
                ...
                items
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/Operations/Monthly/MonthlyAdvice.aspx" style="margin-bottom:0px" />
