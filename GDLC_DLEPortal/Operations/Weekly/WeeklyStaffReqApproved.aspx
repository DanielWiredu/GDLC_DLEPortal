<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeeklyStaffReqApproved.aspx.cs" Inherits="GDLC_DLEPortal.Operations.Weekly.WeeklyStaffReqApproved" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="weeklyStaffReqSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TOP (30) AutoNo, ReqNo, date_, Approved, DLEcodeCompanyName, WorkerName FROM vwWeeklyReq WHERE (ReqNo LIKE '%' + @ReqNo + '%') AND Approved = 1 ORDER BY AutoNo DESC">
                            <SelectParameters>
