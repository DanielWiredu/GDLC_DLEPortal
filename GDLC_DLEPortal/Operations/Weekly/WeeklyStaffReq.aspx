<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeeklyStaffReq.aspx.cs" Inherits="GDLC_DLEPortal.Operations.Weekly.WeeklyStaffReq" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                         ...
                         <hr />
                             <telerik:RadGrid ID="weeklyStaffReqGrid" runat="server" DataSourceID="weeklyStaffReqSource" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="true" AllowSorting="True" CellSpacing="-1" GridLines="Both" OnItemCommand="weeklyStaffReqGrid_ItemCommand" OnDeleteCommand="weeklyStaffReqGrid_DeleteCommand">
                            <ClientSettings>
