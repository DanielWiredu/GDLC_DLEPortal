<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeeklyAdvice.aspx.cs" Inherits="GDLC_DLEPortal.Operations.Weekly.WeeklyAdvice" %>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <asp:Button runat="server" ID="btnAddNew" CssClass="btn btn-success" Text="Add" CausesValidation="false" PostBackUrl="~/Operations/Weekly/NewWeeklyAdivce.aspx"/>  
                                            </div>
                                        </div>
                                    </div>
