<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="GDLC_DLEPortal.GDLCAdmin.Security.EditUser" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                         ...
                         <asp:TextBox ID="txtUserkey" runat="server" Width="100%" MaxLength="2" ReadOnly="true"></asp:TextBox>
            ...
            <FooterTemplate>
                ...
                items
                                        ...
                                        <asp:SqlDataSource ID="dleSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DLEcodeCompanyID,DLEcodeCompanyName FROM [tblDLECompany] WHERE Active = 1 ORDER BY DLEcodeCompanyName"></asp:SqlDataSource>
                    ...
                    <asp:Button ID="btnUpdate" CssClass="btn btn-primary" runat="server" Text="Update" OnClick="btnUpdate_Click" OnClientClick="if (Page_IsValid) {this.value='Processing...';this.disabled=true; }" UseSubmitBehavior="false"  />         
                </div>
                            </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
