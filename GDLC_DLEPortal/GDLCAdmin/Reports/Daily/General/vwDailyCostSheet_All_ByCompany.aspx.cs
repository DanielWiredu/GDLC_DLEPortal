...
{
    public partial class vwDailyCostSheet_All_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyCostSheet_All_ByCompany";
            ...
            {
                DailyCostSheetReport_All_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            DailyCostSheetReport_All_ByCompany.ReportSource = rpt;
        }
    }
}