...
namespace GDLC_DLEPortal.GDLCAdmin.Reports.Monthly
{
    public partial class vwMonthlyReports : MasterPageChange
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                string reqno = "";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "newTab", "window.open('/GDLCAdmin/Reports/Monthly/General/vwMonthlyCostSheet.aspx?reqno=" + reqno + "&st=" + startdate + "&ed=" + enddate + "');", true);
            }
