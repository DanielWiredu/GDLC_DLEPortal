<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="MonthlyStaffReq.aspx.cs" Inherits="GDLC_DLEPortal.GDLCAdmin.Operations.MonthlyStaffReq" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                         ...
                         <hr />
                             <telerik:RadGrid ID="monthlyStaffReqGrid" runat="server" DataSourceID="monthlyStaffReqSource" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="true" AllowSorting="True" CellSpacing="-1" GridLines="Both" OnItemCommand="monthlyStaffReqGrid_ItemCommand">
                            <ClientSettings>
                            ...
                            <GroupingSettings CaseSensitive="false" />
                                 ...
                                 <MasterTableView DataKeyNames="ReqNo" DataSourceID="monthlyStaffReqSource" PageSize="100">
                                     <Columns>
