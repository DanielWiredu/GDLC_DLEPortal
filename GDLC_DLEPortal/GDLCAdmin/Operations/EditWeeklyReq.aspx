<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="EditWeeklyReq.aspx.cs" Inherits="GDLC_DLEPortal.GDLCAdmin.Operations.EditWeeklyReq" %>
                ...
                items
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/GDLCAdmin/Operations/WeeklyStaffReq.aspx" style="margin-bottom:0px" />
