<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DailyApprovalNew.aspx.cs" Inherits="GDLC_DLEPortal.Audit.Approvals.DailyApprovalNew" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <FooterTemplate>
                ...
                items
                                    ...
                                    <div class="col-sm-8">
                                        <telerik:RadTimePicker ID="tpNormalFrom" runat="server" Width="49%" TimePopupButton-Visible="false">
                                        ...
                                        <telerik:RadTimePicker ID="tpNormalTo" runat="server" Width="49%" TimePopupButton-Visible="false">
                                            <ClientEvents OnDateSelected="OnNormalTimeSelected" />
                                        </telerik:RadTimePicker>
                                    ...
                                    <%--<div class="form-group">
                                    <label class="col-sm-4 control-label">Test Times</label>
                                    <div class="col-sm-8">
                                        <asp:ListBox runat="server" ID="lstItems" Width="100%" Height="300"></asp:ListBox>
                                    </div>
                                </div>--%>
                                </div>
                            </div>
            ...
            <FooterTemplate>
                ...
                items
                                    ...
                                    <div class="col-sm-8">
                                        <telerik:RadTimePicker ID="tpOvertimeFrom" runat="server" Width="49%" TimePopupButton-Visible="false">
                                        ...
                                        <telerik:RadTimePicker ID="tpOvertimeTo" runat="server" Width="49%" TimePopupButton-Visible="false">
                                            <ClientEvents OnDateSelected="OnOverTimeSelected" />
                                        </telerik:RadTimePicker>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="subStaffReqSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM vwSubStaffReq WHERE (ReqNo = @ReqNo)">
                            <SelectParameters>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnApprove" Text="Approve" CssClass="btn btn-primary" OnClick="btnApprove_Click" OnClientClick="if (Page_IsValid) {this.value='Processing...';this.disabled=true; }" UseSubmitBehavior="false" />
                        </div>   
                    </ContentTemplate>
                </asp:UpdatePanel>
                    </div>
